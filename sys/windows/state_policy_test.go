...
func TestWindowsAFDTargetProfileRejectsMixedAFDEndpointFamilies(t *testing.T) {
	...
	broken := windowsPolicyTestDeserialize(t, profiled,
		"NtCreateFile$afd_tcp_endpoint(&(0x7f0000000000)=<r0=>0xffffffffffffffff, 0xc0100000, &(0x7f00000000c0)={0x30, 0x0, 0x0, &(0x7f0000000080)={0x16, 0x18, 0x0, &(0x7f0000000040)}}, &(0x7f0000000100)={@Status=0x7f, 0x75f}, 0x0, 0x0, 0x3, 0x3, 0x0, &(0x7f0000000140), 0x34)\n"+
			"NtDeviceIoControlFile$afd_receive_datagram_udp_bound_nonblock(r0, 0x0, 0x0, 0x0, &(0x7f00000003c0)={@Pointer=0x7fff, 0x9}, 0x1201b, &(0x7f00000004c0)={&(0x7f0000000440)=[{0x4, &(0x7f0000000400)='ping'}], 0x1, 0x2, {&(0x7f0000000480)={0x2, 0x4e22, 0x7f000001}}, {0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x10, 0x0, &(0x7f0000000500)={0x2, 0x4e23, 0x7f000001}}}, 0x48, 0x0, 0x0)\n")
	if profiled.RuntimePolicy.ShouldScheduleProgram("fuzz", broken) {
	...
	valid := windowsPolicyTestDeserialize(t, profiled,
		"NtCreateFile$afd_udp_endpoint(&(0x7f0000000000)=<r0=>0xffffffffffffffff, 0xc0100000, &(0x7f00000000c0)={0x30, 0x0, 0x0, &(0x7f0000000080)={0x16, 0x18, 0x0, &(0x7f0000000040)}}, &(0x7f0000000100)={@Pointer=0x7, 0x7a85bf3b}, 0x0, 0x0, 0x3, 0x3, 0x0, &(0x7f0000000140), 0x34)\n"+
			"NtDeviceIoControlFile$afd_bind_udp(r0, 0x0, 0x0, 0x0, &(0x7f0000000180)={@Status=0x7, 0xfff}, 0x12003, &(0x7f00000001c0)={0x1}, 0x14, &(0x7f0000000200), 0x10)\n"+
			"NtDeviceIoControlFile$afd_set_information_nonblock_udp_bound(r0, 0x0, 0x0, 0x0, &(0x7f0000000240)={@Status=0x2, 0x8}, 0x1203b, &(0x7f0000000280)={0x2, 0x0, 0x1}, 0x10, 0x0, 0x0)\n"+
			"NtDeviceIoControlFile$afd_receive_datagram_udp_bound_nonblock(r0, 0x0, 0x0, 0x0, &(0x7f00000002c0)={@Pointer=0x7fff, 0x9}, 0x1201b, &(0x7f00000003c0)={&(0x7f0000000340)=[{0x4, &(0x7f0000000300)='pong'}], 0x1, 0x2, {&(0x7f0000000380)={0x2, 0x4e22, 0x7f000001}}}, 0x48, 0x0, 0x0)\n")
	if !profiled.RuntimePolicy.ShouldScheduleProgram("fuzz", valid) {
...
func TestWindowsAFDTargetProfileRejectsMismatchedAFDReturnedSequence(t *testing.T) {
	...
	broken := windowsPolicyTestDeserialize(t, profiled,
		"NtCreateFile$afd_tcp_endpoint(&(0x7f0000000000)=<r0=>0xffffffffffffffff, 0xc0100000, &(0x7f00000000c0)={0x30, 0x0, 0x0, &(0x7f0000000080)={0x16, 0x18, 0x0, &(0x7f0000000040)}}, &(0x7f0000000100)={@Status=0x7f, 0x75f}, 0x0, 0x0, 0x3, 0x3, 0x0, &(0x7f0000000140), 0x34)\n"+
			"NtDeviceIoControlFile$afd_bind_tcp(r0, 0x0, 0x0, 0x0, &(0x7f0000000180)={@Status=0x8001, 0x80000000}, 0x12003, &(0x7f00000001c0), 0x14, &(0x7f0000000200), 0x10)\n"+
			...
			"NtDeviceIoControlFile$afd_bind_tcp_listener(r2, 0x0, 0x0, 0x0, &(0x7f0000000400)={@Status=0x3, 0x5}, 0x12003, &(0x7f0000000440), 0x14, &(0x7f0000000480), 0x10)\n"+
			"NtDeviceIoControlFile$afd_start_listen_tcp(r2, 0x0, 0x0, 0x0, &(0x7f00000004c0)={@Status=0x1, 0x21}, 0x1200b, &(0x7f0000000500)={0x0, '\\x00', 0x6}, 0xc, 0x0, 0x0)\n"+
			"NtDeviceIoControlFile$afd_connect_tcp_to_listener(r0, 0x0, 0x0, 0x0, &(0x7f0000000240)={@Pointer=0x1, 0x9}, 0x12007, &(0x7f0000000540)={0x0, '\\x00', 0x0, r2}, 0x28, &(0x7f0000000580), 0x10)\n"+
			"NtDeviceIoControlFile$afd_wait_for_listen_tcp(r2, 0x0, 0x0, 0x0, &(0x7f00000005c0)={@Status=0x1, 0x6}, 0x1200c, 0x0, 0x0, &(0x7f0000000600)={<r7=>0x0}, 0x14)\n"+
			...
			"NtDeviceIoControlFile$afd_bind_tcp(r8, 0x0, 0x0, 0x0, &(0x7f0000000800)={@Status=0x8}, 0x12003, &(0x7f0000000840)={0x3}, 0x14, &(0x7f0000000880), 0x10)\n"+
			...
			"NtDeviceIoControlFile$afd_bind_tcp_listener(r10, 0x0, 0x0, 0x0, &(0x7f0000000a80)={@Status=0x67e, 0x3}, 0x12003, &(0x7f0000000ac0), 0x14, &(0x7f0000000b00), 0x10)\n"+
			"NtDeviceIoControlFile$afd_start_listen_tcp(r10, 0x0, 0x0, 0x0, &(0x7f0000000b40)={@Status, 0xc4b7}, 0x1200b, &(0x7f0000000b80)={0x0, '\\x00', 0x2}, 0xc, 0x0, 0x0)\n"+
			"NtDeviceIoControlFile$afd_connect_tcp_to_listener(r8, 0x0, 0x0, 0x0, &(0x7f00000008c0)={@Status=0x1, 0x30}, 0x12007, &(0x7f0000000bc0)={0x0, '\\x00', 0x0, r10}, 0x28, &(0x7f0000000c00), 0x10)\n"+
			"NtDeviceIoControlFile$afd_wait_for_listen_lifo_tcp(r10, 0x0, 0x0, 0x0, &(0x7f0000000c40)={@Pointer=0x3, 0x500000000000000}, 0x12090, 0x0, 0x0, &(0x7f0000000c80)={<r14=>0x0}, 0x14)\n"+
			"NtDeviceIoControlFile$afd_get_unaccepted_connect_data_tcp(r2, 0x0, 0x0, 0x0, &(0x7f0000000640)={@Status=0x1, 0x7}, 0x120a7, &(0x7f0000000cc0)={r14}, 0xc, &(0x7f0000000d00), 0xc)\n")
	if profiled.RuntimePolicy.ShouldScheduleProgram("fuzz", broken) {
...
func TestWindowsAFDTargetProfileRejectsDuplicatePrivateStateEdges(t *testing.T) {
	profiled := windowsPolicyTestAFDTarget(t)
	p := windowsPolicyTestDeserialize(t, profiled,
		"NtCreateFile$afd_tcp_endpoint(&(0x7f0000030000)=<r0=>0x0, 0xc0100000, &(0x7f0000030040)={0x30, 0x0, 0x0, &(0x7f0000030080)={0x16, 0x18, 0x0, &(0x7f00000300c0)={0x5c, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x5c, 0x41, 0x66, 0x64, 0x0}}, 0x40, 0x0, 0x0, 0x0}, &(0x7f0000030140)={@Status=0x0, 0x0}, 0x0, 0x0, 0x3, 0x3, 0x0, &(0x7f0000030180)={0x0, 0x0, 0xf, 0x1c, {0x41, 0x66, 0x64, 0x4f, 0x70, 0x65, 0x6e, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x58, 0x58, 0x0}, {0x0, 0x0, 0x2, 0x1, 0x6, 0x0, 0x0}}, 0x34)\n"+
			"NtDeviceIoControlFile$afd_bind_tcp_listener(r0, 0x0, 0x0, 0x0, &(0x7f0000030200)={@Status=0x0, 0x0}, 0x12003, &(0x7f0000030240)={0x3, {0x2, 0x4e22, 0x7f000001, [0, 0, 0, 0, 0, 0, 0, 0]}}, 0x14, &(0x7f0000030280), 0x10)\n"+
			"NtDeviceIoControlFile$afd_start_listen_tcp(r0, 0x0, 0x0, 0x0, &(0x7f00000302c0)={@Status=0x0, 0x0}, 0x1200b, &(0x7f0000030300)={0x0, [0, 0, 0], 0x1, 0x0, [0, 0, 0]}, 0xc, 0x0, 0x0)\n"+
			"NtDeviceIoControlFile$afd_start_listen_tcp(r0, 0x0, 0x0, 0x0, &(0x7f0000030340)={@Status=0x0, 0x0}, 0x1200b, &(0x7f0000030380)={0x0, [0, 0, 0], 0x1, 0x0, [0, 0, 0]}, 0xc, 0x0, 0x0)\n")
	if profiled.RuntimePolicy.ShouldScheduleProgram("seed", p) {
		t.Fatalf("focused profile scheduled duplicate private state edge:\n%s", p.Serialize())
	}
}

func TestWindowsAFDTargetProfileRejectsConnectToListenerWithoutListeningRoot(t *testing.T) {
	profiled := windowsPolicyTestAFDTarget(t)
	p := windowsPolicyTestDeserialize(t, profiled,
		"NtCreateFile$afd_tcp_endpoint(&(0x7f0000030000)=<r0=>0x0, 0xc0100000, &(0x7f0000030040)={0x30, 0x0, 0x0, &(0x7f0000030080)={0x16, 0x18, 0x0, &(0x7f00000300c0)={0x5c, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x5c, 0x41, 0x66, 0x64, 0x0}}, 0x40, 0x0, 0x0, 0x0}, &(0x7f0000030140)={@Status=0x0, 0x0}, 0x0, 0x0, 0x3, 0x3, 0x0, &(0x7f0000030180)={0x0, 0x0, 0xf, 0x1c, {0x41, 0x66, 0x64, 0x4f, 0x70, 0x65, 0x6e, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x58, 0x58, 0x0}, {0x0, 0x0, 0x2, 0x1, 0x6, 0x0, 0x0}}, 0x34)\n"+
			"NtDeviceIoControlFile$afd_bind_tcp_listener(r0, 0x0, 0x0, 0x0, &(0x7f0000030200)={@Status=0x0, 0x0}, 0x12003, &(0x7f0000030240)={0x3, {0x2, 0x4e22, 0x7f000001, [0, 0, 0, 0, 0, 0, 0, 0]}}, 0x14, &(0x7f0000030280), 0x10)\n"+
			"NtCreateFile$afd_tcp_endpoint(&(0x7f0000030340)=<r2=>0x0, 0xc0100000, &(0x7f0000030380)={0x30, 0x0, 0x0, &(0x7f00000303c0)={0x16, 0x18, 0x0, &(0x7f0000030400)={0x5c, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x5c, 0x41, 0x66, 0x64, 0x0}}, 0x40, 0x0, 0x0, 0x0}, &(0x7f0000030480)={@Status=0x0, 0x0}, 0x0, 0x0, 0x3, 0x3, 0x0, &(0x7f00000304c0)={0x0, 0x0, 0xf, 0x1c, {0x41, 0x66, 0x64, 0x4f, 0x70, 0x65, 0x6e, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x58, 0x58, 0x0}, {0x0, 0x0, 0x2, 0x1, 0x6, 0x0, 0x0}}, 0x34)\n"+
			"NtDeviceIoControlFile$afd_bind_tcp(r2, 0x0, 0x0, 0x0, &(0x7f0000030540)={@Status=0x0, 0x0}, 0x12003, &(0x7f0000030580)={0x3, {0x2, 0x0, 0x7f000001, [0, 0, 0, 0, 0, 0, 0, 0]}}, 0x14, &(0x7f00000305c0), 0x10)\n"+
			"NtDeviceIoControlFile$afd_connect_tcp_to_listener(r2, 0x0, 0x0, 0x0, &(0x7f0000030600)={@Status=0x0, 0x0}, 0x12007, &(0x7f0000030640)={0x0, [0, 0, 0, 0, 0, 0, 0], 0x0, r0, {0x2, 0x4e22, 0x7f000001, [0, 0, 0, 0, 0, 0, 0, 0]}}, 0x28, &(0x7f0000030680)={@Status=0x0, 0x0}, 0x10)\n")
	if profiled.RuntimePolicy.ShouldScheduleProgram("seed", p) {
		t.Fatalf("focused profile scheduled connect-to-listener without listening root:\n%s", p.Serialize())
	}
}

func TestWindowsAFDTargetProfileValidatesPendingCleanupState(t *testing.T) {
	profiled := windowsPolicyTestAFDTarget(t)
	invalid := windowsPolicyTestDeserialize(t, profiled,
		"NtCreateFile$afd_udp_endpoint(&(0x7f0000040000)=<r0=>0x0, 0xc0100000, &(0x7f0000040040)={0x30, 0x0, 0x0, &(0x7f0000040080)={0x16, 0x18, 0x0, &(0x7f00000400c0)={0x5c, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x5c, 0x41, 0x66, 0x64, 0x0}}, 0x40, 0x0, 0x0, 0x0}, &(0x7f0000040140)={@Status=0x0, 0x0}, 0x0, 0x0, 0x3, 0x3, 0x0, &(0x7f0000040180)={0x0, 0x0, 0xf, 0x1c, {0x41, 0x66, 0x64, 0x4f, 0x70, 0x65, 0x6e, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x58, 0x58, 0x0}, {0x1, 0x0, 0x2, 0x2, 0x11, 0x0, 0x0}}, 0x34)\n"+
			"NtDeviceIoControlFile$afd_bind_udp(r0, 0x0, 0x0, 0x0, &(0x7f0000040200)={@Status=0x0, 0x0}, 0x12003, &(0x7f0000040240)={0x3, {0x2, 0x4e24, 0x7f000001, [0, 0, 0, 0, 0, 0, 0, 0]}}, 0x14, &(0x7f0000040280), 0x10)\n"+
			"NtDeviceIoControlFile$afd_set_information_nonblock_udp_bound(r0, 0x0, 0x0, 0x0, &(0x7f00000402c0)={@Status=0x0, 0x0}, 0x1203b, &(0x7f0000040300)={0x2, 0x0, 0x1}, 0x10, 0x0, 0x0)\n"+
			"CloseHandle$afd_address_list_change_pending_nonblock(r0)\n")
	if profiled.RuntimePolicy.ShouldScheduleProgram("seed", invalid) {
		t.Fatalf("focused profile scheduled pending cleanup without producer:\n%s", invalid.Serialize())
	}
	...
	valid := windowsPolicyTestDeserialize(t, profiled,
		"NtCreateFile$afd_udp_endpoint(&(0x7f0000040000)=<r0=>0x0, 0xc0100000, &(0x7f0000040040)={0x30, 0x0, 0x0, &(0x7f0000040080)={0x16, 0x18, 0x0, &(0x7f00000400c0)={0x5c, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x5c, 0x41, 0x66, 0x64, 0x0}}, 0x40, 0x0, 0x0, 0x0}, &(0x7f0000040140)={@Status=0x0, 0x0}, 0x0, 0x0, 0x3, 0x3, 0x0, &(0x7f0000040180)={0x0, 0x0, 0xf, 0x1c, {0x41, 0x66, 0x64, 0x4f, 0x70, 0x65, 0x6e, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x58, 0x58, 0x0}, {0x1, 0x0, 0x2, 0x2, 0x11, 0x0, 0x0}}, 0x34)\n"+
			"NtDeviceIoControlFile$afd_bind_udp(r0, 0x0, 0x0, 0x0, &(0x7f0000040200)={@Status=0x0, 0x0}, 0x12003, &(0x7f0000040240)={0x3, {0x2, 0x4e24, 0x7f000001, [0, 0, 0, 0, 0, 0, 0, 0]}}, 0x14, &(0x7f0000040280), 0x10)\n"+
			"NtDeviceIoControlFile$afd_set_information_nonblock_udp_bound(r0, 0x0, 0x0, 0x0, &(0x7f00000402c0)={@Status=0x0, 0x0}, 0x1203b, &(0x7f0000040300)={0x2, 0x0, 0x1}, 0x10, 0x0, 0x0)\n"+
			"NtDeviceIoControlFile$afd_address_list_change_udp_nonblock(r0, 0x0, 0x0, 0x0, &(0x7f0000040340)={@Status=0x0, 0x0}, 0x120b4, &(0x7f0000040380)={0x0, 0x0, 0x0, 0x0}, 0x20, 0x0, 0x0)\n"+
			"CloseHandle$afd_address_list_change_pending_nonblock(r0)\n")
	if !profiled.RuntimePolicy.ShouldScheduleProgram("seed", valid) {
		t.Fatalf("focused profile rejected matching pending cleanup chain:\n%s", valid.Serialize())
	}
}

func TestWindowsAFDTargetProfileAllowsUnmodeledPrivateFamilies(t *testing.T) {
	profiled := windowsPolicyTestAFDTarget(t)
	for _, file := range []string{
		"test/nyx_afd_private_full_057_NtDeviceIoControlFile_afd_tli_type1_nobuf.txt",
		"test/nyx_afd_private_full_047_NtDeviceIoControlFile_afd_rio_create_cq.txt",
		"test/nyx_afd_private_full_324_NtDeviceIoControlFile_afd_san_fast_complete_request.txt",
	} {
		...
		if !profiled.RuntimePolicy.ShouldScheduleProgram("candidate", p) {
			t.Fatalf("focused profile rejected unmodeled AFD private family %s:\n%s",
				file, p.Serialize())
		}
	}
}
