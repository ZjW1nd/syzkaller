	...
	Windows: {
		AMD64: {
			...
			SyscallTrampolines: map[string]string{
				...
				"NtDeviceIoControlFile$afd_wait_for_listen_tcp":                         "windows_nt_device_io_control_file_output_int32_state",
				"NtDeviceIoControlFile$afd_wait_for_listen_tcp_nonblock":                "windows_nt_device_io_control_file_output_int32_state",
				"NtDeviceIoControlFile$afd_wait_for_listen_delayed_tcp":                 "windows_nt_device_io_control_file_output_int32_state",
				"NtDeviceIoControlFile$afd_wait_for_listen_delayed_tcp_nonblock":        "windows_nt_device_io_control_file_output_int32_state",
				"NtDeviceIoControlFile$afd_wait_for_listen_lifo_tcp":                    "windows_nt_device_io_control_file_output_int32_state",
				"NtDeviceIoControlFile$afd_wait_for_listen_lifo_tcp_nonblock":           "windows_nt_device_io_control_file_output_int32_state",
				...
				"NtDeviceIoControlFile$afd_san_fast_unknown_1210b":                      "windows_nt_device_io_control_file_state",
