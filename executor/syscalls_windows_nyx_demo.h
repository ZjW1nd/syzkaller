...
#define W32_ACCEPT_INET_TCP              2916
#define W32_ACCEPT_INET_TCP_NONBLOCK     2917
#define W32_BIND_CONNECTEX_TCP           2924
#define W32_BIND_INET_TCP                2925
#define W32_BIND_INET_UDP                2926
...
#define W32_CLOSESOCKET_ACCEPT_PENDING   2928
#define W32_CLOSESOCKET_ACCEPT_RECV_PENDING 2929
#define W32_CLOSESOCKET_ACCEPT_SEND_PENDING 2930
#define W32_CLOSESOCKET_ANY              2931
#define W32_CLOSESOCKET_CONNECT_PENDING  2932
#define W32_CLOSESOCKET_TCP_RECV_PENDING 2933
#define W32_CLOSESOCKET_TCP_SEND_PENDING 2934
#define W32_CLOSESOCKET_TCP_SHUTDOWN_RD  2935
#define W32_CLOSESOCKET_TCP_SHUTDOWN_WR  2936
#define W32_CONNECTEX_INET_TCP           340
#define W32_CONNECTEX_INET_TCP_PENDING   341
#define W32_CONNECTEX_INET_TCP_REUSE     342
#define W32_CONNECT_INET_TCP             2938
#define W32_CONNECT_INET_TCP_NONBLOCK    2939
#define W32_CONNECT_INET_UDP             2940
...
#define W32_GETPEERNAME_ACCEPT           2945
#define W32_GETPEERNAME_TCP              2946
#define W32_GETPEERNAME_UDP              2947
#define W32_GETQUEUEDCOMPLETIONSTATUS_SOCKET 1341
#define W32_GETSOCKNAME_ACCEPT           2953
#define W32_GETSOCKNAME_TCP              2954
#define W32_GETSOCKNAME_UDP              2955
#define W32_GETSOCKOPT_INT_ACCEPT        2957
#define W32_GETSOCKOPT_INT_ACCEPT_UPDATED 2958
#define W32_GETSOCKOPT_INT_TCP           2959
#define W32_GETSOCKOPT_INT_UDP           2960
#define W32_IOCTLSOCKET_FIONBIO_ACCEPT   2966
#define W32_IOCTLSOCKET_FIONBIO_ACCEPT_NONBLOCK 2967
#define W32_IOCTLSOCKET_FIONBIO_LISTENER 2968
#define W32_IOCTLSOCKET_FIONBIO_TCP      2969
#define W32_IOCTLSOCKET_FIONBIO_TCP_CONNECTED 2970
#define W32_IOCTLSOCKET_FIONBIO_TCP_CREATED 2971
#define W32_IOCTLSOCKET_FIONBIO_UDP      2972
#define W32_IOCTLSOCKET_FIONBIO_UDP_BOUND 2973
#define W32_IOCTLSOCKET_FIONBIO_UDP_PEER 2974
#define W32_LISTEN_INET_TCP              2986
...
#define W32_RECVFROM_UDP_BOUND           3086
#define W32_RECVFROM_UDP_BOUND_NONBLOCK  3087
#define W32_RECVFROM_UDP_CONNECTED       3088
#define W32_RECVFROM_UDP_CONNECTED_NONBLOCK 3089
#define W32_RECV_INET_ACCEPT             3078
#define W32_RECV_INET_ACCEPT_NONBLOCK    3079
#define W32_RECV_INET_ACCEPT_UPDATED     3080
#define W32_RECV_INET_TCP                3081
#define W32_RECV_INET_TCP_NONBLOCK       3082
#define W32_RECV_INET_UDP                3083
#define W32_RECV_INET_UDP_NONBLOCK       3084
#define W32_SELECT_AFD_ACCEPT_NONBLOCK   3091
#define W32_SELECT_AFD_BASIC             3092
#define W32_SENDTO_UDP_BOUND             3099
#define W32_SENDTO_UDP_CONNECTED         3100
#define W32_SEND_INET_ACCEPT             3094
#define W32_SEND_INET_ACCEPT_UPDATED     3095
#define W32_SEND_INET_TCP                3096
#define W32_SEND_INET_UDP                3097
#define W32_SETFILEINFOBYHANDLE          2428
#define W32_SETSOCKOPT_INT_ACCEPT        3102
#define W32_SETSOCKOPT_INT_ACCEPT_UPDATED 3103
#define W32_SETSOCKOPT_INT_TCP           3104
#define W32_SETSOCKOPT_INT_UDP           3105
#define W32_SETSOCKOPT_UPDATE_ACCEPT_CONTEXT 3106
#define W32_SHUTDOWN_ACCEPT              3107
#define W32_SHUTDOWN_ACCEPT_RD           3108
#define W32_SHUTDOWN_ACCEPT_WR           3109
#define W32_SHUTDOWN_TCP                 3110
#define W32_SHUTDOWN_TCP_RD              3111
#define W32_SHUTDOWN_TCP_WR              3112
#define W32_SOCKET_ACCEPT_TCP            3115
#define W32_SOCKET_BOUND_UDP             3116
#define W32_SOCKET_CONNECTED_TCP         3117
#define W32_SOCKET_CONNECTED_UDP         3118
#define W32_SOCKET_INET_TCP              3119
#define W32_SOCKET_INET_UDP              3120
#define W32_SOCKET_LISTENER_TCP          3121
#define W32_SYZ_EMIT_ETHERNET_WINDOWS    3128
#define W32_SYZ_EXTRACT_TCP_RES_WINDOWS  3130
#define W32_SYZ_EXTRACT_TCP_RES_WINDOWS_SYNACK 3131
#define W32_SYZ_KAFL_BUGCHECK_TRIGGER    3132
#define W32_TRANSMITFILE_INET_ACCEPT     2686
#define W32_TRANSMITPACKETS_INET_ACCEPT  2688
#define W32_VIRTUALALLOC                 2755
#define W32_WRITEFILE                    2902
#define W32_WSACLEANUP                   2800
#define W32_WSACLOSEEVENT                2801
#define W32_WSACREATEEVENT               2802
#define W32_WSAENUMNETWORKEVENTS_ACCEPT  2803
#define W32_WSAENUMNETWORKEVENTS_ACCEPT_NONBLOCK 2804
#define W32_WSAENUMNETWORKEVENTS_TCP     2805
#define W32_WSAENUMNETWORKEVENTS_TCP_NONBLOCK 2806
#define W32_WSAEVENTSELECT_ACCEPT        2807
#define W32_WSAEVENTSELECT_ACCEPT_NONBLOCK 2808
#define W32_WSAEVENTSELECT_TCP           2809
#define W32_WSAEVENTSELECT_TCP_NONBLOCK  2810
#define W32_WSAGETOVERLAPPEDRESULT_ACCEPT_PENDING 2812
#define W32_WSAGETOVERLAPPEDRESULT_ACCEPT_RECV_PENDING 2813
#define W32_WSAGETOVERLAPPEDRESULT_ACCEPT_SEND_PENDING 2814
#define W32_WSAGETOVERLAPPEDRESULT_CONNECT_PENDING 2815
#define W32_WSAGETOVERLAPPEDRESULT_SOCKET 2816
#define W32_WSAGETOVERLAPPEDRESULT_TCP_RECV_PENDING 2817
#define W32_WSAGETOVERLAPPEDRESULT_TCP_SEND_PENDING 2818
#define W32_WSAIOCTL_SIO_ADDRESS_LIST_QUERY 2820
#define W32_WSAIOCTL_SIO_GET_EXTENSION_FUNCTION_POINTER 2821
#define W32_WSAIOCTL_SIO_GET_INTERFACE_LIST 2822
#define W32_WSAIOCTL_SIO_KEEPALIVE_VALS  2823
#define W32_WSAIOCTL_SIO_ROUTING_INTERFACE_QUERY 2824
#define W32_WSAIOCTL_SIO_UDP_CONNRESET   2825
#define W32_WSARECVEX_INET_ACCEPT        2835
#define W32_WSARECVEX_INET_ACCEPT_NONBLOCK 2836
#define W32_WSARECVFROM_UDP              2838
#define W32_WSARECVFROM_UDP_NONBLOCK     2839
#define W32_WSARECVMSG_UDP               2841
#define W32_WSARECVMSG_UDP_NONBLOCK      2842
#define W32_WSARECV_ACCEPT               2828
#define W32_WSARECV_ACCEPT_NONBLOCK      2829
#define W32_WSARECV_ACCEPT_PENDING       2830
#define W32_WSARECV_TCP                  2831
#define W32_WSARECV_TCP_NONBLOCK         2832
#define W32_WSARECV_TCP_PENDING          2833
#define W32_WSARESETEVENT                2843
#define W32_WSASENDTO_UDP                2850
#define W32_WSASEND_ACCEPT               2845
#define W32_WSASEND_ACCEPT_PENDING       2846
#define W32_WSASEND_TCP                  2847
#define W32_WSASEND_TCP_PENDING          2848
#define W32_WSASTARTUP                   2853
