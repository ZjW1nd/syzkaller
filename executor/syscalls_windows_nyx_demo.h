...
#define W32_ACCEPT_INET_TCP              2918
#define W32_ACCEPT_INET_TCP_NONBLOCK     2919
#define W32_BIND_CONNECTEX_TCP           2926
#define W32_BIND_INET_TCP                2927
#define W32_BIND_INET_UDP                2928
...
#define W32_CLOSESOCKET_ACCEPT_PENDING   2930
#define W32_CLOSESOCKET_ACCEPT_RECV_PENDING 2931
#define W32_CLOSESOCKET_ACCEPT_SEND_PENDING 2932
#define W32_CLOSESOCKET_ANY              2933
#define W32_CLOSESOCKET_CONNECT_PENDING  2934
#define W32_CLOSESOCKET_TCP_RECV_PENDING 2935
#define W32_CLOSESOCKET_TCP_SEND_PENDING 2936
#define W32_CLOSESOCKET_TCP_SHUTDOWN_RD  2937
#define W32_CLOSESOCKET_TCP_SHUTDOWN_WR  2938
#define W32_CONNECTEX_INET_TCP           340
#define W32_CONNECTEX_INET_TCP_PENDING   341
#define W32_CONNECTEX_INET_TCP_REUSE     342
#define W32_CONNECT_INET_TCP             2940
#define W32_CONNECT_INET_TCP_NONBLOCK    2941
#define W32_CONNECT_INET_UDP             2942
...
#define W32_GETPEERNAME_ACCEPT           2947
#define W32_GETPEERNAME_TCP              2948
#define W32_GETPEERNAME_UDP              2949
#define W32_GETQUEUEDCOMPLETIONSTATUS_SOCKET 1341
#define W32_GETSOCKNAME_ACCEPT           2955
#define W32_GETSOCKNAME_TCP              2956
#define W32_GETSOCKNAME_UDP              2957
#define W32_GETSOCKOPT_INT_ACCEPT        2959
#define W32_GETSOCKOPT_INT_ACCEPT_UPDATED 2960
#define W32_GETSOCKOPT_INT_TCP           2961
#define W32_GETSOCKOPT_INT_UDP           2962
#define W32_IOCTLSOCKET_FIONBIO_ACCEPT   2968
#define W32_IOCTLSOCKET_FIONBIO_ACCEPT_NONBLOCK 2969
#define W32_IOCTLSOCKET_FIONBIO_LISTENER 2970
#define W32_IOCTLSOCKET_FIONBIO_TCP      2971
#define W32_IOCTLSOCKET_FIONBIO_TCP_CONNECTED 2972
#define W32_IOCTLSOCKET_FIONBIO_TCP_CREATED 2973
#define W32_IOCTLSOCKET_FIONBIO_UDP      2974
#define W32_IOCTLSOCKET_FIONBIO_UDP_BOUND 2975
#define W32_IOCTLSOCKET_FIONBIO_UDP_PEER 2976
#define W32_LISTEN_INET_TCP              2988
...
#define W32_NTDEVICEIOCTLFILE_AFD_ENUM_NETWORK_EVENTS_ACCEPT_NONBLOCK 1843
#define W32_NTDEVICEIOCTLFILE_AFD_EVENT_SELECT_ACCEPT 1844
#define W32_NTDEVICEIOCTLFILE_AFD_EVENT_SELECT_ACCEPT_NONBLOCK 1845
#define W32_NTDEVICEIOCTLFILE_AFD_GET_CONTEXT_TCP 1846
#define W32_NTDEVICEIOCTLFILE_AFD_GET_QOS_ACCEPT 1847
#define W32_NTDEVICEIOCTLFILE_AFD_GET_QOS_TCP 1848
#define W32_NTDEVICEIOCTLFILE_AFD_GET_QOS_UDP 1849
#define W32_NTDEVICEIOCTLFILE_AFD_GET_REMOTE_ADDRESS_TCP 1850
#define W32_NTDEVICEIOCTLFILE_AFD_NOOP_ACCEPT 1851
#define W32_NTDEVICEIOCTLFILE_AFD_NOOP_TCP 1852
#define W32_NTDEVICEIOCTLFILE_AFD_NOOP_UDP 1853
#define W32_NTDEVICEIOCTLFILE_AFD_POLL_ACCEPT 1854
#define W32_NTDEVICEIOCTLFILE_AFD_POLL_ACCEPT_NONBLOCK 1855
#define W32_NTDEVICEIOCTLFILE_AFD_QUERY_HANDLES_ACCEPT 1856
#define W32_NTDEVICEIOCTLFILE_AFD_QUERY_HANDLES_TCP 1857
#define W32_NTDEVICEIOCTLFILE_AFD_QUERY_HANDLES_UDP 1858
#define W32_NTDEVICEIOCTLFILE_AFD_QUERY_HANDLES_UDP_PEER 1859
#define W32_NTDEVICEIOCTLFILE_AFD_QUERY_RECV_ACCEPT 1860
#define W32_NTDEVICEIOCTLFILE_AFD_QUERY_RECV_TCP 1861
#define W32_NTDEVICEIOCTLFILE_AFD_ROUTING_INTERFACE_QUERY_UDP 1862
#define W32_NTFLUSHICACHE                1863
#define W32_NTFLUSHWBUF                  1864
#define W32_NTFSCONTROLFILE              1865
#define W32_NTFSCONTROLFILE_NTFS_GET_COMP 1866
#define W32_NTFSCONTROLFILE_NTFS_QUERY_ALLOC_RANGES 1867
#define W32_NTFSCONTROLFILE_NTFS_SET_COMP 1868
#define W32_NTFSCONTROLFILE_NTFS_SET_SPARSE 1869
#define W32_NTFSCONTROLFILE_NTFS_SET_ZERO_DATA 1870
#define W32_NTPOWERINFO                  1871
#define W32_NTQINFOFILE_BASIC            1874
#define W32_NTQINFOFILE_NETOPEN          1875
#define W32_NTQINFOFILE_STANDARD         1876
#define W32_NTQINFO_PROC                 1877
#define W32_NTQINFO_SYS                  1879
#define W32_NTQUERYDEFLOCALE             1872
#define W32_NTQUERYDEFUILANG             1873
#define W32_NTQUERYPERFCTR               1878
#define W32_NTQUERYSYSTIME               1880
#define W32_NTQUERYTIMERRES              1881
#define W32_NTREADFILE                   1882
#define W32_NTSETINFOFILE_BASIC          1883
#define W32_NTSETINFO_PROC               1884
#define W32_NTSETTIMERRES                1885
#define W32_NTWRITEFILE                  1886
#define W32_NTYIELDEXEC                  1887
#define W32_READFILE                     2038
#define W32_RECVFROM_UDP_BOUND           3088
#define W32_RECVFROM_UDP_BOUND_NONBLOCK  3089
#define W32_RECVFROM_UDP_CONNECTED       3090
#define W32_RECVFROM_UDP_CONNECTED_NONBLOCK 3091
#define W32_RECV_INET_ACCEPT             3080
#define W32_RECV_INET_ACCEPT_NONBLOCK    3081
#define W32_RECV_INET_ACCEPT_UPDATED     3082
#define W32_RECV_INET_TCP                3083
#define W32_RECV_INET_TCP_NONBLOCK       3084
#define W32_RECV_INET_UDP                3085
#define W32_RECV_INET_UDP_NONBLOCK       3086
#define W32_SELECT_AFD_ACCEPT_NONBLOCK   3093
#define W32_SELECT_AFD_BASIC             3094
#define W32_SENDTO_UDP_BOUND             3101
#define W32_SENDTO_UDP_CONNECTED         3102
#define W32_SEND_INET_ACCEPT             3096
#define W32_SEND_INET_ACCEPT_UPDATED     3097
#define W32_SEND_INET_TCP                3098
#define W32_SEND_INET_UDP                3099
#define W32_SETFILEINFOBYHANDLE          2428
#define W32_SETSOCKOPT_INT_ACCEPT        3104
#define W32_SETSOCKOPT_INT_ACCEPT_UPDATED 3105
#define W32_SETSOCKOPT_INT_TCP           3106
#define W32_SETSOCKOPT_INT_UDP           3107
#define W32_SETSOCKOPT_UPDATE_ACCEPT_CONTEXT 3108
#define W32_SHUTDOWN_ACCEPT              3109
#define W32_SHUTDOWN_ACCEPT_RD           3110
#define W32_SHUTDOWN_ACCEPT_WR           3111
#define W32_SHUTDOWN_TCP                 3112
#define W32_SHUTDOWN_TCP_RD              3113
#define W32_SHUTDOWN_TCP_WR              3114
#define W32_SOCKET_ACCEPT_TCP            3117
#define W32_SOCKET_BOUND_UDP             3118
#define W32_SOCKET_CONNECTED_TCP         3119
#define W32_SOCKET_CONNECTED_UDP         3120
#define W32_SOCKET_INET_TCP              3121
#define W32_SOCKET_INET_UDP              3122
#define W32_SOCKET_LISTENER_TCP          3123
#define W32_SYZ_EMIT_ETHERNET_WINDOWS    3130
#define W32_SYZ_EXTRACT_TCP_RES_WINDOWS  3132
#define W32_SYZ_EXTRACT_TCP_RES_WINDOWS_SYNACK 3133
#define W32_SYZ_KAFL_BUGCHECK_TRIGGER    3134
#define W32_TRANSMITFILE_INET_ACCEPT     2686
#define W32_TRANSMITFILE_INET_ACCEPT_NONBLOCK 2687
#define W32_TRANSMITPACKETS_INET_ACCEPT  2689
#define W32_TRANSMITPACKETS_INET_ACCEPT_NONBLOCK 2690
#define W32_VIRTUALALLOC                 2757
#define W32_WRITEFILE                    2904
#define W32_WSACLEANUP                   2802
#define W32_WSACLOSEEVENT                2803
#define W32_WSACREATEEVENT               2804
#define W32_WSAENUMNETWORKEVENTS_ACCEPT  2805
#define W32_WSAENUMNETWORKEVENTS_ACCEPT_NONBLOCK 2806
#define W32_WSAENUMNETWORKEVENTS_TCP     2807
#define W32_WSAENUMNETWORKEVENTS_TCP_NONBLOCK 2808
#define W32_WSAEVENTSELECT_ACCEPT        2809
#define W32_WSAEVENTSELECT_ACCEPT_NONBLOCK 2810
#define W32_WSAEVENTSELECT_TCP           2811
#define W32_WSAEVENTSELECT_TCP_NONBLOCK  2812
#define W32_WSAGETOVERLAPPEDRESULT_ACCEPT_PENDING 2814
#define W32_WSAGETOVERLAPPEDRESULT_ACCEPT_RECV_PENDING 2815
#define W32_WSAGETOVERLAPPEDRESULT_ACCEPT_SEND_PENDING 2816
#define W32_WSAGETOVERLAPPEDRESULT_CONNECT_PENDING 2817
#define W32_WSAGETOVERLAPPEDRESULT_SOCKET 2818
#define W32_WSAGETOVERLAPPEDRESULT_TCP_RECV_PENDING 2819
#define W32_WSAGETOVERLAPPEDRESULT_TCP_SEND_PENDING 2820
#define W32_WSAIOCTL_SIO_ADDRESS_LIST_QUERY 2822
#define W32_WSAIOCTL_SIO_GET_EXTENSION_FUNCTION_POINTER 2823
#define W32_WSAIOCTL_SIO_GET_INTERFACE_LIST 2824
#define W32_WSAIOCTL_SIO_KEEPALIVE_VALS  2825
#define W32_WSAIOCTL_SIO_ROUTING_INTERFACE_QUERY 2826
#define W32_WSAIOCTL_SIO_UDP_CONNRESET   2827
#define W32_WSARECVEX_INET_ACCEPT        2837
#define W32_WSARECVEX_INET_ACCEPT_NONBLOCK 2838
#define W32_WSARECVFROM_UDP              2840
#define W32_WSARECVFROM_UDP_NONBLOCK     2841
#define W32_WSARECVMSG_UDP               2843
#define W32_WSARECVMSG_UDP_NONBLOCK      2844
#define W32_WSARECV_ACCEPT               2830
#define W32_WSARECV_ACCEPT_NONBLOCK      2831
#define W32_WSARECV_ACCEPT_PENDING       2832
#define W32_WSARECV_TCP                  2833
#define W32_WSARECV_TCP_NONBLOCK         2834
#define W32_WSARECV_TCP_PENDING          2835
#define W32_WSARESETEVENT                2845
#define W32_WSASENDTO_UDP                2852
#define W32_WSASEND_ACCEPT               2847
#define W32_WSASEND_ACCEPT_PENDING       2848
#define W32_WSASEND_TCP                  2849
#define W32_WSASEND_TCP_PENDING          2850
#define W32_WSASTARTUP                   2855
